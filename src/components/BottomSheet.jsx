  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-t-2xl bg-white shadow-xl sm:rounded-lg">
        ...
        <div className="p-4" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>{children}</div>
      </div>
    </div>
  )
}
