...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  const content = (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 min-h-screen min-h-[100dvh]"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-lg bg-white shadow-xl flex flex-col">
