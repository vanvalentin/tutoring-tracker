...
const tabs = [
  ...
  { path: '/material', label: 'Business', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  { path: '/personal-expenses', label: 'Personal', icon: 'M3 7h18M7 7V5a2 2 0 012-2h6a2 2 0 012 2v2m-9 4h10m-11 4h12m-13 4h14' },
...
const moreNavItems = [
  { path: '/personal-expenses', label: 'Personal Expenses' },
